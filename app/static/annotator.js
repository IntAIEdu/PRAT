/**
 * File for the manual annotation of the text
 *
 * @Author Modified by Luca Mirenda
 */
...
$("#modalAddRelation").ready(function(){
    ...
    /** Function to check the symmetry of a relation.
     * Symmetry is present if A is prerequisite of B and B is prerequisite of A
     *
     * @param prereq: first concept
     * @param advanced: second concept
     * @return true if simmetry, false if not
     */
    function checkSymmetric(prereq, advanced){
     ...
     /** Function to check if the relation will introduce a cycle.
     *
     * @param prereq: first concept
     * @param advanced: second concept
     * @return BFS: boolean
    ...
    /** Function to get all the words that have concept as prerequisite.
     *
     * @param concept
     * @return neighbors: list of concepts
     */
     ...
     *
     * @param from: first concept
     * @param to: second concept
     * @return boolean, true if the 2 concepts are linked
     */
