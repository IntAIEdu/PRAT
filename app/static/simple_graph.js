/**
 Javascript file used to visualize the simple graph
 Author: { Andrea Sava , ... }
*/
    ...
    */
    ...
    /**
 * Function that highlight the nodes in simple graph
 *
 * @param {nodes} nodes.
 * @param {boolean} on.
 * @return {boolean} d.data.color.
 */
...
function zoom() {
    console.log("centro il grafo")

    $(".jsnx").children().attr("transform", "translate(92.78259517592119,447.70442477157343)scale(0.09014138557174962)")
