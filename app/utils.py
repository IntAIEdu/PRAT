# -*- coding: utf-8 -*-
#------------------------------------------------------------------
# File with all the utility functions
#
...
def id_phrase(conll, result):
    ...
    :param conll
    :param result: list of phrases
    :return phraseid: list of ids
    """
...
def data_analysis(conll, words, sentences, bid, cap, method):
    ...
    :param conll
    :param words
    :param sentences: list of phrases
    :param bid: book id
    :param cap: chapter id
    :param method: user or method id

    :return dfAnnotation: dataframe of the annotation
    :return df: dataframe containing each word and its frequence, sections and sentence of appearance":
    :return metrics: data of the annotation (number of default concepts, number of entered concepts, number of relations..)
    :return words
    """
    lemmatizer = WordNetLemmatizer()
...
def getRelations(bid,cap,rel_id):
    """
    Get the selected relations of a user annotation, or baseline method

    :param bid: book id
    :param cap: chapter id
    :param rel_id:
        - if user -> rel_id = uid. + user id
        - if baseline method -> rel_id = id method

    :return:
        - if user -> list with (prereq, target, weight)
        - if baseline method -> list with ( prereq, target)
...
def get_df_gold(gid):
    """
    Get dataframe containing all the relations of a gold standard

    :param gid: gold stardard id
    :return: dataframe of relations
    """
...
def find_term(lemma):
    """
    If present, get id of the concept, else return lemma in uppercase

    :param lemma: concept to find
    :return: id of the lemma if present in the database
    """
...
def agreement_json(bid, cap, uid):
    ...
    :param cap: chapter id
    :param uid: user id
    :return: dict with all the relations
    """
    dict_list = []
...
def linguistic_json(bid, cap, uid):
    """
     Get relations of the user annotation for the linguistic analysis

    :param bid: book id
    :param cap: chapter id
    :param uid: user id
    :return: dict with all the relations of the annotation
    """
    dict_list = []
    ann_list = Annotations.query.filter_by(bid=bid, cap=cap).all()
...
def linguistic_json_gold(bid, cap, gid):
    """
     Get relations of the gold standard for the linguistic analysis

    :param bid: book id
    :param cap: chapter id
    :param gid: gold standard id
    :return: dict with all the relations of the gold standard
    """
    dict_list = []
...
def linguistic_json_method2(bid, cap):
    """
    Get relations of the baseline method 2 for the linguistic analysis
...
def scores(bid, cap, dfAnnotation_method, dfAnnotation_Gold, method):
    """
    Find accuracy, precision, recall, F1 score of an annotation using the gold standard

    :param bid: book id
    :param cap: chapter id
    :param dfAnnotation_method: relations of the annotation
    :param dfAnnotation_Gold: relations of the gold standard
...
def get_list_annotations(bid,cap):
    ...
    :param bid: book id
    :param cap: chapter id
    :return: list with all the annotations
    """
    annotationList = []
