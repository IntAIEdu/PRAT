**Sample dataset annotated with Prerequisite Relations according to PREAP (PRErequisite Annotation Protocol)**<p>
...
![Metadata describing the sample dataset](https://github.com/Teldh/PRET/blob/master/data/PREAP-sample-CS-dataset/dataset-metadata.jpg "Metadata describing the sample dataset")
