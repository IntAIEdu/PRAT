**dataset_v1: AUTONOMOUS AUTOMATIC concepts annotation and manual PR annotation**
...
![Metadata describing the sample dataset](https://github.com/IntAIEdu/PRAT/blob/main/data/case-study-ML/PREAP-datasets-versions/dataset_v1/dataset-metadata_v1.png)
